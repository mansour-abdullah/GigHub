    ...
    public class GigsController : Controller
    {
       ...
       [Authorize]
        ...
        public ActionResult Details(int id)
        {
            ...
            var viewModel = new DetailViewModel{Gig = gig};

            if (User.Identity.IsAuthenticated)
            {
                var userId = User.Identity.GetUserId();
                viewModel.Attending = _unitOfWork.Attendance.GetAttendance(gig.Id, userId) != null;

                viewModel.Following = _unitOfWork.Following.GetFollowing(userId, gig.ArtistId) != null;
            }
